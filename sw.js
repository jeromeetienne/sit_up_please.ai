...
const BUILD_IDENTIFIER = "68e9a8a0de3b";
...
const PRECACHE_PATHS = [
	...
	"./assets/index-CzG_cc95.js",
	"./assets/index-D2LzkqEA.css",
	"./favicon.ico",
...
const SINGLE_INSTRUCTION_PATHS = ["./wasm/vision_wasm_internal.js","./wasm/vision_wasm_internal.wasm"];

/** The WebAssembly runtime for a browser without the single-instruction operations. */
const NO_SINGLE_INSTRUCTION_PATHS = ["./wasm/vision_wasm_nosimd_internal.js","./wasm/vision_wasm_nosimd_internal.wasm"];
